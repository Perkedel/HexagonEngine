...
func _ready():
	...
	$MeshInstance3D.scale = Vector3(1.5, 1, 1.5)
	...
	$ColorTween.interpolate_property($MeshInstance3D, "scale", Vector3(1.5, 1, 1.5), Vector3(1,  1, 1), 0.4, Tween.TRANS_SINE, Tween.EASE_IN_OUT)
	$ColorTween.start()
