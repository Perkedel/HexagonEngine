...
func play_bgm(bgm : String, reset_to_defaults : bool = true) -> void:
	...
	if (Preloaded_Resources.has(bgm_file_name)):
		...
		var bgm_file_path = BGM_DIR_PATH + "/" + bgm_file_name if (bgm.get_base_dir() == "" || bgm.get_base_dir() == BGM_DIR_PATH || bgm.get_base_dir() == BGM_DIR_PATH + "/") else bgm;
...
func play_bgs(bgs : String, reset_to_defaults : bool = true, override_current_sound : bool = true, sound_to_override : String = "") -> void:
	...
	if (Preloaded_Resources.has(bgs_file_name)):
		...
		var bgs_file_path = BGS_DIR_PATH + "/" + bgs_file_name if (bgs.get_base_dir() == "" || bgs.get_base_dir() == BGS_DIR_PATH || bgs.get_base_dir() == BGS_DIR_PATH + "/") else bgs;
...
func play_se(sound_effect : String, reset_to_defaults : bool = true, override_current_sound : bool = true, sound_to_override : String = "") -> void:
	...
	if (Preloaded_Resources.has(sound_effect_file_name)):
		...
		var sound_effect_path = SFX_DIR_PATH + "/" + sound_effect_file_name if (sound_effect.get_base_dir() == "" || sound_effect.get_base_dir() == SFX_DIR_PATH || sound_effect.get_base_dir() == SFX_DIR_PATH + "/") else sound_effect;
...
func play_me(music_effect : String, reset_to_defaults : bool = true, override_current_sound : bool = true, sound_to_override : String = "") -> void:
	...
	if (Preloaded_Resources.has(music_effect_file_name)):
		...
		var music_effect_path = MFX_DIR_PATH + "/" + music_effect_file_name if (music_effect.get_base_dir() == MFX_DIR_PATH || music_effect.get_base_dir() == MFX_DIR_PATH + "/") else music_effect;
